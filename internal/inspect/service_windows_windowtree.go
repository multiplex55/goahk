...
var (
	user32WindowTreeDLL      = windows.NewLazySystemDLL("user32.dll")
	procGetParent            = user32WindowTreeDLL.NewProc("GetParent")
	procGetWindow            = user32WindowTreeDLL.NewProc("GetWindow")
	procGetForegroundWindow  = user32WindowTreeDLL.NewProc("GetForegroundWindow")
	procGetCursorPos         = user32WindowTreeDLL.NewProc("GetCursorPos")
	procWindowFromPoint      = user32WindowTreeDLL.NewProc("WindowFromPoint")
	procGetWindowTextLengthW = user32WindowTreeDLL.NewProc("GetWindowTextLengthW")
	procGetWindowTextW       = user32WindowTreeDLL.NewProc("GetWindowTextW")
	procGetClassNameW        = user32WindowTreeDLL.NewProc("GetClassNameW")
	procGetWindowRect        = user32WindowTreeDLL.NewProc("GetWindowRect")
	procGetWindowThreadPID   = user32WindowTreeDLL.NewProc("GetWindowThreadProcessId")
	procIsWindowEnabled      = user32WindowTreeDLL.NewProc("IsWindowEnabled")
	procIsWindowVisible      = user32WindowTreeDLL.NewProc("IsWindowVisible")
)
